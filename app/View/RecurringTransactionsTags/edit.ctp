...
<?php echo $this->Form->create('RecurringTransactionsTag'); ?>
	<fieldset>
		<legend><?php echo __('Edit Recurring Transactions Tag'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RecurringTransactionsTag.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('RecurringTransactionsTag.id'))); ?></li>
